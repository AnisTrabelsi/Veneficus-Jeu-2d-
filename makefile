travail:background.o main.o fonction.o hero.o enigmealeatoire.o enigmealf.o enigmestat.o jeux.o ennemi.o functions.o
	gcc  background.o main.o fonction.o hero.o enigmealeatoire.o enigmealf.o enigmestat.o jeux.o ennemi.o functions.o -o VENEFICUS -lSDL -lSDL_mixer -lSDL_image -lSDL_ttf -g
main.o:main.c	
